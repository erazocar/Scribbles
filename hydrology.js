export default class hydro {
    ...
    /** rainfallrunoff: does simple rainfall-runoff analyses over a rainfall dataset given landuse, baseflow and infiltration capacity.
     ...
     */
    rainfallrunoff = function(arr, parm, vars){
